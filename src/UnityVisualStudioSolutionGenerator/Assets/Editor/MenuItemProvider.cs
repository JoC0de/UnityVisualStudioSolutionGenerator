...
namespace UnityVisualStudioSolutionGenerator
{
    ...
    {
        [MenuItem("Visual Studio/Generate Solution (Sdk-Style)", priority = 0)]
        ...
        [MenuItem("Visual Studio/Generate Solution (Legacy-Style)", priority = 1)]
        ...
        [MenuItem("Visual Studio/Enable Verbose Logging", priority = 2)]
